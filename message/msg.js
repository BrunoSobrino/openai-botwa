...
try {
const _0x4b05ee=_0x4a35;function _0x33d4(){const _0x326fd9=['application/json','users','2959461DawmbL','Ai:','json','text-davinci-003','post','20499jvxMuO','assistant','3013016gzWcJW','34zNiVqu','content','user','5cTUYyQ','trim','message','https://api.openai.com/v1/chat/completions','system','data','4123880jYatwv','Bearer\x20','11zYDZBJ','createCompletion','stringify','log','result','7BGLLLb','chatgpt','1335864pFyRkI','Human:','21832BteMpI','choices','https://api.lolhuman.xyz/api/openai?apikey=BrunoSobrino&text=','gpt-3.5-turbo','12473820cFKupb','60WVQabP'];_0x33d4=function(){return _0x326fd9;};return _0x33d4();}(function(_0x4429dd,_0x4d4f79){const _0x49f9b6=_0x4a35,_0x336d5c=_0x4429dd();while(!![]){try{const _0x223faa=parseInt(_0x49f9b6(0x1ef))/0x1*(-parseInt(_0x49f9b6(0x1f2))/0x2)+parseInt(_0x49f9b6(0x1e7))/0x3*(parseInt(_0x49f9b6(0x1e2))/0x4)+-parseInt(_0x49f9b6(0x1d1))/0x5*(parseInt(_0x49f9b6(0x1e0))/0x6)+parseInt(_0x49f9b6(0x1de))/0x7*(parseInt(_0x49f9b6(0x1f1))/0x8)+-parseInt(_0x49f9b6(0x1ea))/0x9+-parseInt(_0x49f9b6(0x1d7))/0xa*(parseInt(_0x49f9b6(0x1d9))/0xb)+parseInt(_0x49f9b6(0x1e6))/0xc;if(_0x223faa===_0x4d4f79)break;else _0x336d5c['push'](_0x336d5c['shift']());}catch(_0x16bfd0){_0x336d5c['push'](_0x336d5c['shift']());}}}(_0x33d4,0x33fc0));function _0x4a35(_0x359deb,_0x14487e){const _0x33d489=_0x33d4();return _0x4a35=function(_0x4a3580,_0x30d70f){_0x4a3580=_0x4a3580-0x1cf;let _0x552b89=_0x33d489[_0x4a3580];return _0x552b89;},_0x4a35(_0x359deb,_0x14487e);}try{let chgptdb=global[_0x4b05ee(0x1df)][_0x4b05ee(0x1d6)][_0x4b05ee(0x1e9)][senderJid];chgptdb['push']({'role':_0x4b05ee(0x1d0),'content':textosinespacio});const config={'method':_0x4b05ee(0x1ee),'url':_0x4b05ee(0x1d4),'headers':{'Content-Type':_0x4b05ee(0x1e8),'Authorization':_0x4b05ee(0x1d8)+OPENAI_KEY},'data':JSON[_0x4b05ee(0x1db)]({'model':_0x4b05ee(0x1e5),'messages':[{'role':_0x4b05ee(0x1d5),'content':''},...chgptdb]})};let response=await axios(config);chgptdb['push']({'role':_0x4b05ee(0x1f0),'content':response[_0x4b05ee(0x1d6)][_0x4b05ee(0x1e3)][0x0][_0x4b05ee(0x1d3)][_0x4b05ee(0x1cf)]}),reply(response[_0x4b05ee(0x1d6)][_0x4b05ee(0x1e3)][0x0]['message'][_0x4b05ee(0x1cf)]);}catch(_0x382eaa){try{const BotIA222=await openai[_0x4b05ee(0x1da)]({'model':_0x4b05ee(0x1ed),'prompt':textosinespacio,'temperature':0.3,'max_tokens':MAX_TOKEN,'stop':[_0x4b05ee(0x1eb),_0x4b05ee(0x1e1)],'top_p':0x1,'frequency_penalty':0.2,'presence_penalty':0x0});reply(BotIA222[_0x4b05ee(0x1d6)][_0x4b05ee(0x1e3)][0x0]['text']['trim']());}catch(_0x31b694){try{let Rrres=await fetch('https://api.ibeng.tech/api/info/openai?text='+textosinespacio+'&apikey=tamvan'),Jjjson=await Rrres[_0x4b05ee(0x1ec)]();m['reply'](Jjjson[_0x4b05ee(0x1d6)][_0x4b05ee(0x1d6)][_0x4b05ee(0x1d2)]());}catch(_0xd94699){try{let tioress22=await fetch(_0x4b05ee(0x1e4)+textosinespacio+'&user=user-unique-id'),hasill22=await tioress22[_0x4b05ee(0x1ec)]();reply((''+hasill22[_0x4b05ee(0x1dd)])['trim']());}catch(_0x2d0dea){console[_0x4b05ee(0x1dc)](_0x2d0dea);}}}}
try {
