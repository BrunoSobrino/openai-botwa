...
const _0x24706d=_0x23ea;function _0x23ea(_0x203d28,_0x232888){const _0x590fec=_0x590f();return _0x23ea=function(_0x23ea33,_0x283b99){_0x23ea33=_0x23ea33-0xa8;let _0x508955=_0x590fec[_0x23ea33];return _0x508955;},_0x23ea(_0x203d28,_0x232888);}(function(_0x5e57e6,_0x565fae){const _0x416a39=_0x23ea,_0xccabee=_0x5e57e6();while(!![]){try{const _0x399c4a=-parseInt(_0x416a39(0xc3))/0x1+parseInt(_0x416a39(0xc8))/0x2*(-parseInt(_0x416a39(0xbb))/0x3)+parseInt(_0x416a39(0xad))/0x4*(parseInt(_0x416a39(0xb0))/0x5)+-parseInt(_0x416a39(0xa8))/0x6*(parseInt(_0x416a39(0xaa))/0x7)+-parseInt(_0x416a39(0xb6))/0x8*(parseInt(_0x416a39(0xb7))/0x9)+-parseInt(_0x416a39(0xc9))/0xa*(parseInt(_0x416a39(0xbc))/0xb)+parseInt(_0x416a39(0xb8))/0xc;if(_0x399c4a===_0x565fae)break;else _0xccabee['push'](_0xccabee['shift']());}catch(_0x10e404){_0xccabee['push'](_0xccabee['shift']());}}}(_0x590f,0xbc06f));function _0x590f(){const _0x198d96=['system','174jZJQob','24410PGnsvl','8322CgYyLo','createCompletion','5971Emdpcn','result','json','992aTYmrx','stringify','choices','20180ENsoOK','message','gpt-3.5-turbo','content','trim','user','352CkTRfm','294282vFDgfx','63146172xSpBra','Ai:','data','21009utqoeX','4279XTaZfg','push','text','https://api.lolhuman.xyz/api/openai?apikey=BrunoSobrino&text=','&user=user-unique-id','Human:','application/json','1312317knnZuX','log','Bearer\x20','post'];_0x590f=function(){return _0x198d96;};return _0x590f();}try{let chgptdb=global['chatgpt']['data']['users'][m['sender']];chgptdb[_0x24706d(0xbd)]({'role':_0x24706d(0xb5),'content':textosinespacio});const config={'method':_0x24706d(0xc6),'url':'https://api.openai.com/v1/chat/completions','headers':{'Content-Type':_0x24706d(0xc2),'Authorization':_0x24706d(0xc5)+OPENAI_KEY},'data':JSON[_0x24706d(0xae)]({'model':_0x24706d(0xb2),'messages':[{'role':_0x24706d(0xc7),'content':''},...chgptdb]})};let response=await axios(config);chgptdb[_0x24706d(0xbd)]({'role':'assistant','content':response[_0x24706d(0xba)][_0x24706d(0xaf)][0x0][_0x24706d(0xb1)][_0x24706d(0xb3)]}),reply(response[_0x24706d(0xba)][_0x24706d(0xaf)][0x0][_0x24706d(0xb1)][_0x24706d(0xb3)]);}catch(_0x1f3888){console[_0x24706d(0xc4)](_0x1f3888);try{const BotIA222=await openai[_0x24706d(0xa9)]({'model':'text-davinci-003','prompt':textosinespacio,'temperature':0.3,'max_tokens':MAX_TOKEN,'stop':[_0x24706d(0xb9),_0x24706d(0xc1)],'top_p':0x1,'frequency_penalty':0.2,'presence_penalty':0x0});reply(BotIA222['data']['choices'][0x0][_0x24706d(0xbe)][_0x24706d(0xb4)]());}catch(_0x298493){console['log'](_0x298493);try{let tioress22=await fetch(_0x24706d(0xbf)+textosinespacio+_0x24706d(0xc0)),hasill22=await tioress22[_0x24706d(0xac)]();reply((''+hasill22[_0x24706d(0xab)])[_0x24706d(0xb4)]());}catch(_0x4dee2a){console[_0x24706d(0xc4)](_0x4dee2a);}}}    
break     
